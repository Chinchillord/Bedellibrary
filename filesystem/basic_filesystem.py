...
def rquery_based_on_tags(tags : List[str], dir : str) -> Iterable[str]:
...
def matches_tags(tags : List[str], filepath : str) -> bool:
...
def semantic_query(query : str, dir : str):
...
def add_tag_to_file(tag : str, filepath : str):
