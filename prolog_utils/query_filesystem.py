...
def prolog_query_filesystem(query : str) -> Iterator[str]:
...
def nat_lang_query_filesystem(query : str) -> str:
...
def update_ontology(request : str):
...
def explain_query_results(query : str) -> str:
